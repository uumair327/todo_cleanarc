...
class AppColors {
  ...
  // Theme preview colors (for theme switcher UI)
  static const Color themePreviewDarkBackground = Color(0xFF121212);
  static const Color themePreviewLightBackground = Color(0xFFFFFFFF);
  static const Color themePreviewDarkText = Color(0xFFFFFFFF);
  static const Color themePreviewLightText = Color(0xFF000000);
