...
// in todo_cleanarc/test/feature/auth/presentation/bloc/sign_up_bloc_test.dart.
...
import 'package:todo_cleanarc/core/domain/value_objects/email.dart' as _i8;
import 'package:todo_cleanarc/core/domain/value_objects/password.dart' as _i9;
...
class MockSignUpUseCase extends _i1.Mock implements _i4.SignUpUseCase {
  ...
  _i5.Future<_i3.Either<_i6.Failure, _i7.UserEntity>> call({
    required _i8.Email? email,
    required _i9.Password? password,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
